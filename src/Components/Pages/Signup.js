...
import image from "..//Images//islamic-wedding-couple-cartoon_491831-70.webp"
import {
...
const Signup = () => {
  ...
  return (
    <div className="lg:flex justify-center items-center h-screen ">
        <img className="w-[500px] items-center   lg:block hidden " src={image} alt="" />
      <form className="" onSubmit={handleSubmit(onSubmit)}>
        ...
        <button
          type="submit"
          class="btn btn-outline btn-primary text-white w-full"
        >
          Sign up
        </button>
